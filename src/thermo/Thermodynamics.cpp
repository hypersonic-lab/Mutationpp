...
void Thermodynamics::setState(
    const double* const p_v1, const double* const p_v2, const int vars, double h, bool NEWTON, bool FORWARD, bool CENTRAL)
{
    mp_state->setState(p_v1, p_v2, vars, h, NEWTON, FORWARD, CENTRAL);
