...
*/
class STSDB_36 : public ThermoDB
{
public:

    STSDB_36(int arg) : ThermoDB(298.15, 101325.0){}
...
// Register the STSDB_36 model with the other thermodynamic databases
Utilities::Config::ObjectProvider<STSDB_36, ThermoDB> stsDB_36("STS36");
