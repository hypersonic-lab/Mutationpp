 ...
 */
class NN2BinsDB : public ThermoDB
{
public:
...
// Register the NN2Bins model with the other thermodynamic databases
Utilities::Config::ObjectProvider<NN2BinsDB, ThermoDB> nn2binsDB("NN2Bins");
