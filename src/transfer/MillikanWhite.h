...
public:
     ...
     */
    MillikanWhitePartner(double a, double b, double ml, double nl, double mh, double nh, double mu)
        : m_a(a), m_b(b), m_ml(ml), m_nl(nl), m_mh(mh), m_nh(nh), m_mu(mu)
    {}
    
    /**
     * Construct using default values of a and b based on mu and theta.
     */
    MillikanWhitePartner(double mu, double theta, double mw, double not_used)
